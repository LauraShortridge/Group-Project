...
function initMap() {
    ...
    map = new google.maps.Map(document.getElementById('map'), {
        center: CWRU,
        zoom: 15,
        // removes user option to switch to terrain, sattelite, etc.
        mapTypeControl: false,
    });

    // sets default travel mode and directions output to 'walking'
    travelMode = 'WALKING';
    var destinationInput = document.getElementById('build');
    var modeSelector = document.getElementById('mode-selector');
    // user can select alternate travel modes
    setupClickListener('changemode-walking', 'WALKING');
    setupClickListener('changemode-transit', 'TRANSIT');
    setupClickListener('changemode-driving', 'DRIVING');
    // positions the user inputs within the map
    ...
    // calls user location early enough to be useful
    geoLocation();
...
// because you can't be paranoid AND ask for directions
